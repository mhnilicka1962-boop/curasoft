...
class CurasoftDemoSeeder extends Seeder
{
    ...
    private function organisationUpdaten(): void
    {
        DB::table('organisationen')->where('id', $this->orgId)->update([
            ...
            'abrechnungslogik'   => 'tiers_payant',
            'medidata_url'       => 'https://www.curasoft.ch/test/medidata',
            'medidata_username'  => 'test',
            'medidata_passwort'  => 'test',
            'updated_at'         => now(),
        ]);
    }
    ...
    private function erstelleKlient1(): void
    {
        ...
        $id = DB::table('klienten')->insertGetId([
            ...
            'gemeinde_adresse'=> 'Sozialdepartement, Werdstrasse 75',
            'gemeinde_plz'    => '8004',
            'gemeinde_ort'    => 'Zürich',
            'gemeinde_email'  => '1234@itjob.ch',
            'aktiv'           => true,
            'created_at'      => now(),
            'updated_at'      => now(),
        ]);
    ...
    private function erstelleKlient5(): void
    {
        ...
        $id = DB::table('klienten')->insertGetId([
            ...
            'gemeinde_plz'                   => '6301',
            'gemeinde_ort'                   => 'Zug',
            'gemeinde_email'                 => 'soziales@stadtzug.ch',
