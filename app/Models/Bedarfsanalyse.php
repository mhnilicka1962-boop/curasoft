...
class Bedarfsanalyse extends Model
{
    ...
    protected $fillable = [
        ...
        'kvg_krankenkasse', 'kvg_anschrift', 'vvg_vorhanden', 'vvg_deckungstyp', 'pflegeversicherung',
        'pflegeversicherung_name', 'zweite_krankenkasse', 'zweite_krankenkasse_anschrift', 'haushaltshilfe',
