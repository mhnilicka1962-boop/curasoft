...
<div class="vo-header">
    ...
    <div class="vo-meta">
        ...
        @if($einsatz->tagespauschale_id)· Tagespauschale@elseif($einsatz->einsatzLeistungsarten->isNotEmpty())· {{ $einsatz->einsatzLeistungsarten->map(fn($el) => $el->leistungsart?->bezeichnung)->filter()->implode(', ') }}@endif
