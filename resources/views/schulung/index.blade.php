...
<div class="karte">
    ...
    $faq = [
        ...
        ['F', 'Was ist eine Einsatzserie?', 'Eine Serie generiert automatisch alle wiederkehrenden Einsätze — z.B. jeden Montag und Mittwoch. Mit «Automatisch verlängern» läuft sie unbegrenzt weiter, ohne dass jemand manuell eingreifen muss. Serien können nicht gelöscht werden, nur inaktiviert («Serie beenden») — zukünftige Einsätze werden dabei gestoppt, die Serie bleibt als Historie erhalten.'],
