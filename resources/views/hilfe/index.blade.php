...
<div id="hilfe-inhalt" style="max-width: 860px;">
    ...
    <div class="karte" id="kap7" style="margin-bottom: 1.25rem;">
        ...
        <div style="display: flex; flex-direction: column; gap: 0.75rem; font-size: 0.9375rem;">
            ...
            <div class="abschnitt-trenn"></div>
            <div><strong>Serie beenden oder pausieren?</strong><br>Klient → Serien → Serie öffnen → <strong>«Serie beenden»</strong> — stoppt die Serie, zukünftige Einsätze werden gelöscht. Zum Neustart: <strong>«Serie neu starten»</strong>.<br><span class="text-hell">Serien können nicht gelöscht werden, nur inaktiviert — die Serie bleibt als Historie erhalten.</span><br><span class="text-hell"><strong>Zeiten oder Wochentage geändert?</strong> Alte Serie inaktivieren → neue Serie mit den neuen Zeiten erfassen.</span></div>
            <div class="abschnitt-trenn"></div>
